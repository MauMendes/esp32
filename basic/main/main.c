...
#define GPIO_OUTPUT_CLK_ENABLE    16
#define GPIO_OUTPUT_PIN_SEL  (1ULL<<GPIO_OUTPUT_CLK_ENABLE)
...
void app_main(void)
{
    //Initalize gpio
    gpio_init();
    gpio_set_level(GPIO_OUTPUT_CLK_ENABLE, 1);
    ESP_LOGI("eth osc enabled:","done");
    ...
    ESP_LOGI("TAG","esp_event_loop_create_default() - PASSED");
    esp_netif_config_t cfg = ESP_NETIF_DEFAULT_ETH();
    esp_netif_t *eth_netif = esp_netif_new(&cfg);
    // Set default handlers to process TCP/IP stuffs
    ESP_ERROR_CHECK(esp_eth_set_default_handlers(eth_netif));
    ESP_LOGI("TAG","esp_eth_set_default_handlers() - PASSED");
    // Register user defined event handers
    ESP_ERROR_CHECK(esp_event_handler_register(ETH_EVENT, ESP_EVENT_ANY_ID, &eth_event_handler, NULL));
    ESP_LOGI("TAG","esp_event_handler_register() - PASSED");
